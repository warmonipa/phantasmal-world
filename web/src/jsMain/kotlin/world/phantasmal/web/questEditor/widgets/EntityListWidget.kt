...
class EntityListWidget(
    ...
    private val uiStore: QuestEditorUiStore? = null,
    ...
    override fun Node.createElement() =
        div {
            ...
            if (isNpcList && uiStore != null) {
                // Check if current area should show omnispawn
                val showOmnispawn = map(ctrl.currentQuest, ctrl.currentArea) { quest, area ->
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            observe(uiStore.omnispawn) { isChecked ->
                                if (isChecked) {
                            ...
                            onclick = { uiStore.setOmnispawn(!uiStore.omnispawn.value) }
